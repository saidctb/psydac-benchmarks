...
def assemble_matrix_z6fv8xca(global_test_basis_v_1, global_test_basis_v_2, global_test_basis_v_3, global_trial_basis_u_1, global_trial_basis_u_2, global_trial_basis_u_3, global_test_basis_mapping_v_1, global_test_basis_mapping_v_2, global_test_basis_mapping_v_3, global_span_v_1, global_span_v_2, global_span_v_3, global_span_mapping_v_1, global_span_mapping_v_2, global_span_mapping_v_3, global_x1, global_x2, global_x3, test_v_p1, test_v_p2, test_v_p3, trial_u_p1, trial_u_p2, trial_u_p3, test_mapping_v_p1, test_mapping_v_p2, test_mapping_v_p3, n_element_1, n_element_2, n_element_3, k1, k2, k3, pad1, pad2, pad3, global_arr_coeffs_x, global_arr_coeffs_y, global_arr_coeffs_z, g_mat_u_v_z6fv8xca):
    ...
    arr_x = zeros((4, 4, 4), dtype='float64')
    arr_x_x3 = zeros((4, 4, 4), dtype='float64')
    arr_x_x3x3 = zeros((4, 4, 4), dtype='float64')
    arr_x_x2 = zeros((4, 4, 4), dtype='float64')
    arr_x_x2x3 = zeros((4, 4, 4), dtype='float64')
    arr_x_x2x2 = zeros((4, 4, 4), dtype='float64')
    arr_x_x1 = zeros((4, 4, 4), dtype='float64')
    arr_x_x1x3 = zeros((4, 4, 4), dtype='float64')
    arr_x_x1x2 = zeros((4, 4, 4), dtype='float64')
    arr_x_x1x1 = zeros((4, 4, 4), dtype='float64')
    arr_y = zeros((4, 4, 4), dtype='float64')
    arr_y_x3 = zeros((4, 4, 4), dtype='float64')
    arr_y_x3x3 = zeros((4, 4, 4), dtype='float64')
    arr_y_x2 = zeros((4, 4, 4), dtype='float64')
    arr_y_x2x3 = zeros((4, 4, 4), dtype='float64')
    arr_y_x2x2 = zeros((4, 4, 4), dtype='float64')
    arr_y_x1 = zeros((4, 4, 4), dtype='float64')
    arr_y_x1x3 = zeros((4, 4, 4), dtype='float64')
    arr_y_x1x2 = zeros((4, 4, 4), dtype='float64')
    arr_y_x1x1 = zeros((4, 4, 4), dtype='float64')
    arr_z = zeros((4, 4, 4), dtype='float64')
    arr_z_x3 = zeros((4, 4, 4), dtype='float64')
    arr_z_x3x3 = zeros((4, 4, 4), dtype='float64')
    arr_z_x2 = zeros((4, 4, 4), dtype='float64')
    arr_z_x2x3 = zeros((4, 4, 4), dtype='float64')
    arr_z_x2x2 = zeros((4, 4, 4), dtype='float64')
    arr_z_x1 = zeros((4, 4, 4), dtype='float64')
    arr_z_x1x3 = zeros((4, 4, 4), dtype='float64')
    arr_z_x1x2 = zeros((4, 4, 4), dtype='float64')
    arr_z_x1x1 = zeros((4, 4, 4), dtype='float64')
                            ...
                            for i_basis_1 in range(0, 4, 1):
                                ...
                                for i_basis_2 in range(0, 4, 1):
                                    ...
                                    for i_basis_3 in range(0, 4, 1):
                                        ...
                                        arr_x[i_quad_1,i_quad_2,i_quad_3] += mapping_v*coeff_x
                                        arr_x_x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3*coeff_x
                                        arr_x_x3x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3x3*coeff_x
                                        arr_x_x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2*coeff_x
                                        arr_x_x2x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x3*coeff_x
                                        arr_x_x2x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x2*coeff_x
                                        arr_x_x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1*coeff_x
                                        arr_x_x1x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x3*coeff_x
                                        arr_x_x1x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x2*coeff_x
                                        arr_x_x1x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x1*coeff_x
                                        arr_y[i_quad_1,i_quad_2,i_quad_3] += mapping_v*coeff_y
                                        arr_y_x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3*coeff_y
                                        arr_y_x3x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3x3*coeff_y
                                        arr_y_x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2*coeff_y
                                        arr_y_x2x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x3*coeff_y
                                        arr_y_x2x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x2*coeff_y
                                        arr_y_x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1*coeff_y
                                        arr_y_x1x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x3*coeff_y
                                        arr_y_x1x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x2*coeff_y
                                        arr_y_x1x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x1*coeff_y
                                        arr_z[i_quad_1,i_quad_2,i_quad_3] += mapping_v*coeff_z
                                        arr_z_x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3*coeff_z
                                        arr_z_x3x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x3x3*coeff_z
                                        arr_z_x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2*coeff_z
                                        arr_z_x2x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x3*coeff_z
                                        arr_z_x2x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x2x2*coeff_z
                                        arr_z_x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1*coeff_z
                                        arr_z_x1x3[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x3*coeff_z
                                        arr_z_x1x2[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x2*coeff_z
                                        arr_z_x1x1[i_quad_1,i_quad_2,i_quad_3] += mapping_v_x1x1*coeff_z
                                        ...
                                        for i_quad_1 in range(0, 4, 1):
                                            ...
                                            for i_quad_2 in range(0, 4, 1):
                                                ...
                                                for i_quad_3 in range(0, 4, 1):
                                                    ...
                                                    x_x3x3 = arr_x_x3x3[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x2 = arr_x_x2[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x2x3 = arr_x_x2x3[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x2x2 = arr_x_x2x2[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x1 = arr_x_x1[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x1x3 = arr_x_x1x3[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x1x2 = arr_x_x1x2[i_quad_1,i_quad_2,i_quad_3]
                                                    x_x1x1 = arr_x_x1x1[i_quad_1,i_quad_2,i_quad_3]
                                                    y = arr_y[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x3 = arr_y_x3[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x3x3 = arr_y_x3x3[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x2 = arr_y_x2[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x2x3 = arr_y_x2x3[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x2x2 = arr_y_x2x2[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x1 = arr_y_x1[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x1x3 = arr_y_x1x3[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x1x2 = arr_y_x1x2[i_quad_1,i_quad_2,i_quad_3]
                                                    y_x1x1 = arr_y_x1x1[i_quad_1,i_quad_2,i_quad_3]
                                                    z = arr_z[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x3 = arr_z_x3[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x3x3 = arr_z_x3x3[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x2 = arr_z_x2[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x2x3 = arr_z_x2x3[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x2x2 = arr_z_x2x2[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x1 = arr_z_x1[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x1x3 = arr_z_x1x3[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x1x2 = arr_z_x1x2[i_quad_1,i_quad_2,i_quad_3]
                                                    z_x1x1 = arr_z_x1x1[i_quad_1,i_quad_2,i_quad_3]
                                                    v = v_1*v_2*v_3
                                                    v_x3 = v_1*v_2*v_3_x3
