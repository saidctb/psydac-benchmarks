...
def assemble_matrix(global_test_basis_TE_0_1, global_test_basis_TE_0_2, global_test_basis_TE_0_3,
    ...
    local_test_basis_TE_0_2 = zeros((global_thread_size_2, 5, 2, 5), dtype='float64')
    local_test_basis_TE_1_2 = zeros((global_thread_size_2, 4, 2, 5), dtype='float64')
    local_test_basis_TE_2_2 = zeros((global_thread_size_2, 5, 2, 5), dtype='float64')
    local_test_basis_TE_0_2[:,:,:,:] = global_test_basis_TE_0_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]
    local_test_basis_TE_1_2[:,:,:,:] = global_test_basis_TE_1_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]
    local_test_basis_TE_2_2[:,:,:,:] = global_test_basis_TE_2_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]

    local_test_basis_TE_0_3 = zeros((global_thread_size_3, 5, 2, 5), dtype='float64')
    local_test_basis_TE_1_3 = zeros((global_thread_size_3, 5, 2, 5), dtype='float64')
    local_test_basis_TE_2_3 = zeros((global_thread_size_3, 4, 2, 5), dtype='float64')
    local_test_basis_TE_0_3[:,:,:,:] = global_test_basis_TE_0_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]
    local_test_basis_TE_1_3[:,:,:,:] = global_test_basis_TE_1_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]
    local_test_basis_TE_2_3[:,:,:,:] = global_test_basis_TE_2_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]

    local_trial_basis_E_0_1 = zeros((global_thread_size_1, 4, 2, 5), dtype='float64')
    local_trial_basis_E_1_1 = zeros((global_thread_size_1, 5, 2, 5), dtype='float64')
    local_trial_basis_E_2_1 = zeros((global_thread_size_1, 5, 2, 5), dtype='float64')
    local_trial_basis_E_0_1[:,:,:,:] = global_trial_basis_E_0_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1],:,:2,:]
    local_trial_basis_E_1_1[:,:,:,:] = global_trial_basis_E_1_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1],:,:2,:]
    local_trial_basis_E_2_1[:,:,:,:] = global_trial_basis_E_2_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1],:,:2,:]

    local_trial_basis_E_0_2 = zeros((global_thread_size_2, 5, 2, 5), dtype='float64')
    local_trial_basis_E_1_2 = zeros((global_thread_size_2, 4, 2, 5), dtype='float64')
    local_trial_basis_E_2_2 = zeros((global_thread_size_2, 5, 2, 5), dtype='float64')
    local_trial_basis_E_0_2[:,:,:,:] = global_trial_basis_E_0_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]
    local_trial_basis_E_1_2[:,:,:,:] = global_trial_basis_E_1_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]
    local_trial_basis_E_2_2[:,:,:,:] = global_trial_basis_E_2_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2],:,:2,:]

    local_trial_basis_E_0_3 = zeros((global_thread_size_3, 5, 2, 5), dtype='float64')
    local_trial_basis_E_1_3 = zeros((global_thread_size_3, 5, 2, 5), dtype='float64')
    local_trial_basis_E_2_3 = zeros((global_thread_size_3, 4, 2, 5), dtype='float64')
    local_trial_basis_E_0_3[:,:,:,:] = global_trial_basis_E_0_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]
    local_trial_basis_E_1_3[:,:,:,:] = global_trial_basis_E_1_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]
    local_trial_basis_E_2_3[:,:,:,:] = global_trial_basis_E_2_3[global_thread_starts_3[thread_coords_3]:1 + global_thread_ends_3[thread_coords_3],:,:2,:]

    local_span_TE_0_1 = zeros((global_thread_size_1,), dtype='int64')
    local_span_TE_1_1 = zeros((global_thread_size_1,), dtype='int64')
    local_span_TE_2_1 = zeros((global_thread_size_1,), dtype='int64')
    local_span_TE_0_1[:] = global_span_TE_0_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1]]
    local_span_TE_1_1[:] = global_span_TE_1_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1]]
    local_span_TE_2_1[:] = global_span_TE_2_1[global_thread_starts_1[thread_coords_1]:1 + global_thread_ends_1[thread_coords_1]]

    local_span_TE_0_2 = zeros((global_thread_size_2,), dtype='int64')
    local_span_TE_1_2 = zeros((global_thread_size_2,), dtype='int64')
    local_span_TE_2_2 = zeros((global_thread_size_2,), dtype='int64')
    local_span_TE_0_2[:] = global_span_TE_0_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2]]
    local_span_TE_1_2[:] = global_span_TE_1_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2]]
    local_span_TE_2_2[:] = global_span_TE_2_2[global_thread_starts_2[thread_coords_2]:1 + global_thread_ends_2[thread_coords_2]]

    local_span_TE_0_3 = zeros((global_thread_size_3,), dtype='int64')
    local_span_TE_1_3 = zeros((global_thread_size_3,), dtype='int64')
    local_span_TE_2_3 = zeros((global_thread_size_3,), dtype='int64')
                                            ...
                                            for j_basis_2 in range(0, 5, 1):
                                                for j_basis_3 in range(0, 5, 1):
                                                    ...
                                                    for i_quad_1 in range(0, 5, 1):
                                                        TE_0_1 = local_test_basis_TE_0_1[i_element_1,i_basis_1,0,i_quad_1]
                                                        E_0_1 = local_trial_basis_E_0_1[i_element_1,j_basis_1,0,i_quad_1]
                                                        for i_quad_2 in range(0, 5, 1):
                                                            TE_0_2 = local_test_basis_TE_0_2[i_element_2,i_basis_2,0,i_quad_2]
                                                            E_0_2  = local_trial_basis_E_0_2[i_element_2,j_basis_2,0,i_quad_2]
                                                            for i_quad_3 in range(0, 5, 1):
                                                                TE_0_3 = local_test_basis_TE_0_3[i_element_3,i_basis_3,0,i_quad_3]
                                                                E_0_3 = local_trial_basis_E_0_3[i_element_3,j_basis_3,0,i_quad_3]
                                        ...
                                        for j_basis_1 in range(0, 5, 1):
                                            for j_basis_2 in range(0, 4, 1):
                                                for j_basis_3 in range(0, 5, 1):
                                                    contribution = 0.0
                                                    for i_quad_1 in range(0, 5, 1):
                                                        TE_1_1 = local_test_basis_TE_1_1[i_element_1,i_basis_1,0,i_quad_1]
                                                        E_1_1 = local_trial_basis_E_1_1[i_element_1,j_basis_1,0,i_quad_1]
                                                        for i_quad_2 in range(0, 5, 1):
                                                            TE_1_2 = local_test_basis_TE_1_2[i_element_2,i_basis_2,0,i_quad_2]
                                                            E_1_2 = local_trial_basis_E_1_2[i_element_2,j_basis_2,0,i_quad_2]
                                                            for i_quad_3 in range(0, 5, 1):
                                                                TE_1_3 = local_test_basis_TE_1_3[i_element_3,i_basis_3,0,i_quad_3]
                                                                E_1_3 = local_trial_basis_E_1_3[i_element_3,j_basis_3,0,i_quad_3]
                                        ...
                                        for j_basis_1 in range(0, 5, 1):
                                            for j_basis_2 in range(0, 5, 1):
                                                for j_basis_3 in range(0, 4, 1):
                                                    ...
                                                    contribution = 0.0
                                                    for i_quad_1 in range(0, 5, 1):
                                                        TE_2_1 = local_test_basis_TE_2_1[i_element_1,i_basis_1,0,i_quad_1]
                                                        E_2_1 = local_trial_basis_E_2_1[i_element_1,j_basis_1,0,i_quad_1]
                                                        for i_quad_2 in range(0, 5, 1):
                                                            TE_2_2 = local_test_basis_TE_2_2[i_element_2,i_basis_2,0,i_quad_2]
                                                            E_2_2 = local_trial_basis_E_2_2[i_element_2,j_basis_2,0,i_quad_2]
                                                            for i_quad_3 in range(0, 5, 1):
                                                                TE_2_3 = local_test_basis_TE_2_3[i_element_3,i_basis_3,0,i_quad_3]
                                                                E_2_3 = local_trial_basis_E_2_3[i_element_3,j_basis_3,0,i_quad_3]
