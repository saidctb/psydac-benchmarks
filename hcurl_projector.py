...
from psydac.feec.global_projectors import Projector_Hcurl
...
def run_hcurl_projector(ncells, degree, comm):

    backend['folder'] = "hcurl_psydac_{}_{}_{}".format(ncells[0], degree[0], comm.size)
    ...
    infos = {}
    infos['title'] = 'hcurl_projector_3d'
    infos['ncells'] = tuple(ncells)
    infos['degree'] = tuple(degree)
 
    t0 = time()
    P1 = Projector_Hcurl(Vh)
...
def parse_input_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        description     = "Run Hcurl projector"
    )
...
if __name__ == '__main__':
    ...
    run_hcurl_projector(ncells, degree, comm)
